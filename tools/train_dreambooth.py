    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                latents1 = vae.encode(batch["pixel_values"].to(dtype=weight_dtype))
                print('latents1 = ')
                print(latents1)
                latents2 = latents1.latent_dist
                print('latents2 = ')
                print(latents2)
                latents = latents2.sample()
                print('latents = ')
                print(latents)
