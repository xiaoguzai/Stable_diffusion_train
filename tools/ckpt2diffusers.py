...
def convert_ldm_clip_checkpoint(checkpoint):
    if os.path.exists(default_model_path):
      text_model = CLIPTextModel.from_pretrained("/home/xiaoguzai/.cache/modelscope/hub/langboat/mengzi-bert-base")
    else:
      text_model = CLIPTextModel.from_pretrained("/home/xiaoguzai/.cache/modelscope/hub/langboat/mengzi-bert-base")
...
if __name__ == "__main__":
    ...
    if text_model_type == "FrozenCLIPEmbedder":
        ...
        if os.path.exists(default_model_path):
          tokenizer = CLIPTokenizer.from_pretrained("/home/xiaoguzai/.cache/modelscope/hub/langboat/Guohua-Diffusion/tokenizer")
        else:  
          tokenizer = CLIPTokenizer.from_pretrained("/home/xiaoguzai/.cache/modelscope/hub/langboat/Guohua-Diffusion/tokenizer")
        ...
        tokenizer = BertTokenizerFast.from_pretrained("/home/xiaoguzai/.cache/modelscope/hub/langboat/mengzi-bert-base")
